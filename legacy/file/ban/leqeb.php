...
$_v->fsize1($fsize1);
echo "Sizin Ban Etmek h&#252;ququnuz yoxdur!<br/>----<br/>\n";
...
$_v->title('Leqeb BAN','center');
$_v->fsize1($fsize1);
if($u_level<$row["level"]){
echo "<b>$pnik</b>,  <u>BAN Edildi</u>!<br/>\n";
mysql_query ("update `users` set `banned` = '1', `whokik` = '".$user."', `whykik` = '".$whykik."', `time` = '".($SERVER_TIME-$_AUTO['ofline'])."' where `id` ='".$pid."';");
...
$txt = "<b>$user_admin</b>, \"<u>$pnik</u>\" leqebli istifade&#231;inin <b>BAN ETDI</b>$whyki\n";
for ($num = 0; $num <= 9; $num++){
$room = "room".$num;
...
@$save= fopen("file/control/7/9".$pid.".dat", "a+"); 
...
@$save= fopen("file/control/7.dat", "a+"); 
$date = date("d.m.y [H:i]",$SERVER_TIME); 
...
$levname = $levels["name"];
echo "Sizin  \"<b>".$levname."</b>\" r&#252;tbesinde olan &#350;exslerin,<br/> <u>Leqebini</u>. Ban etmek h&#252;ququnuz yoxdur!<br/>\n";
}
echo "----<br/>";
if($rm!=""){
