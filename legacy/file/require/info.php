...
$select = @mysql_query ("Select `id`,`user`,`name`,`sex`,`img`,`bal`,`status`,`time`,".$order_level."`mesaj`,`para`,`tox`,`mexvi`,`birth`,`meqsed`,`city`,`infa`,`posts`,`credits`,`gposts`,`date`,`room`,`forum`,`fpost`,`roompost`,`level`,`zn`,`qefes`,`xstatus`,`time_active`,`image_fon`,`infostat`,`nnposts`,`anket`,`ankets` from `users` where `id`='".$nk."' ".$table_banned.";");
