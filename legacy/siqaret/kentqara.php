...
echo "<small><b>Bu Siqaretin Deyeri 180 bal</b></small><br/>\n";
...
echo "<small><anchor>[Bu Siqareti Al]<go href=\"kentqara.php?id=$id&amp;ps=$ps&amp;ver=wml\" method=\"post\">\n";
...
mysql_query("Update `users` set `bal`=bal-'180' where id ='".$id."';");

mysql_query("Update `users` set `siqaret`='4' where id ='".$id."';");
...
$messagead = "H&#246;rmetli Admin! <b>$us</b> leqebli istifade&#231;i <u>Qara Kent</u> siqareti ald&#305;.";
