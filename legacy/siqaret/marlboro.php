...
echo "<small><b>Bu Siqaretin Deyeri 220 bal</b></small><br/>\n";
...
echo "<small><anchor>[Bu Siqareti Al]<go href=\"marlboro.php?id=$id&amp;ps=$ps&amp;ver=wml\" method=\"post\">\n";
...
mysql_query("Update `users` set `bal`=bal-'220' where id ='".$id."';");
...
$messagead = "H&#246;rmetli Admin! <b>$us</b> leqebli istifade&#231;i <u>Marlboro</u> siqareti ald&#305;.";
