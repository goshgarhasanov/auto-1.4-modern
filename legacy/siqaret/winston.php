...
echo "<small><b>Bu Siqaretin Deyeri 170 bal</b></small><br/>\n";
...
echo "<small><anchor>[Bu Siqareti Al]<go href=\"winston.php?id=$id&amp;ps=$ps&amp;ver=wml\" method=\"post\">\n";
...
mysql_query("Update `users` set `bal`=bal-'170' where id ='".$id."';");

mysql_query("Update `users` set `siqaret`='3' where id ='".$id."';");
...
$messagead = "H&#246;rmetli Admin! <b>$us</b> leqebli istifade&#231;i <u>Winston</u> siqareti ald&#305;.";
