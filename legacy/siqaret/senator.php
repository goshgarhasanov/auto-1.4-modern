...
echo "<img src=\"senator.jpg\" alt=\"senator\"/>";
...
echo "<small><b>Bu Siqaretin Deyeri 500 bal</b></small><br/>\n";
...
echo "<small><anchor>[Bu Siqareti Al]<go href=\"senator.php?id=$id&amp;ps=$ps&amp;ver=wml\" method=\"post\">\n";
...
mysql_query("Update `users` set `bal`=bal-'500' where id ='".$id."';");

mysql_query("Update `users` set `siqaret`='8' where id ='".$id."';");
...
//mysql_query("INSERT INTO `chato` VALUES(0, '5', 'Magaza Sahibi', '".$message."', '0', '".date("H:i:s")."', ".time().");");
...
$messagead = "H&#246;rmetli Admin! <b>$us</b> leqebli istifade&#231;i <u>Senator</u> siqareti ald&#305;.";
