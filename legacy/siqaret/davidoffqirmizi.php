...
echo "<small><b>Bu Siqaretin Deyeri 200 bal</b></small><br/>\n";
...
echo "<small><anchor>[Bu Siqareti Al]<go href=\"davidoffqirmizi.php?id=$id&amp;ps=$ps&amp;ver=wml\" method=\"post\">\n";
...
mysql_query("Update `users` set `bal`=bal-'200' where id ='".$id."';");

mysql_query("Update `users` set `siqaret`='6' where id ='".$id."';");
...
$messagead = "H&#246;rmetli Admin! <b>$us</b> leqebli istifade&#231;i <u>Q&#305;rm&#305;z&#305; Davidoff</u> siqareti ald&#305;.";
