...
if ($row['bal'] < $seg['info_comment'])
{
	$_v->title('Bal yetersizdir');
	$_v->fsize1($fsize1);
	echo "$nick leqebli &#350;exsi tebrik ve ya terif etmek &#252;&#231;&#252;n,<br/> Size <b>".$seg['infocomment']."</b>, bal laz&#305;md&#305;r.<br/>\n";
...
if(!isset($_POST['action']))
{
    ...
    if (mysql_affected_rows()!=0) {
        echo "<b>".$nick."</b> sizi iqnor edib...<br/>Bu o demekdir kim <u>".$nick."</u> Sizinle dan&#305;&#351;maq ve ona rey bildirmenizi istemir!<br/>\n";
    } else {
