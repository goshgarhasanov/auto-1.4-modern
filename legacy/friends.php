...
if($time >$SERVER_TIME-$_AUTO['ofline']){
...
if ($nk == 1) {
echo "H&#246;rmetli: <u>".$us."</u>: <b>$site Rehberi $_AUTO[admin] Meslehet bilende Sizi &#246;z&#252; Dostlar&#305;ndan Silecek!!!</b><br/>";
} else {
...
mysql_query("INSERT INTO `zapiski` SET `idtowhom` = '".$nk."',`towhom` = '".$nickname."',`idwho` = '0',`time` = '".$SERVER_TIME."',`who` = 'Sistem',`date` = '',`readd` = '0',`topic` = 'Dostluq',`message` = '".$metn."';");
...
case 'add': 
if ($nick == 1) {
echo "H&#246;rmetli: <u>".$us."</u>: <b>$site Rehberi $_AUTO[admin] Meslehet bilende Size &#246;z&#252; Teklif G&#246;nderecek!!!</b><br/>";
} else {
if ($id == $nick) {
...
if($row['level']<9){
if ($dost==1) {
echo "<u>Bu istifade&#231;i Dosluq qebul etmir..!</u><br/>\n";
$_v->divide();
