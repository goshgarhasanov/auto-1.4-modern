...
echo "<card id=\"index\" title=\"Kart 21\">\n";
echo "<p align=\"center\">\n";
print $fsize1;
...
echo $divide;
echo "<a href=\"../oyunlar.php?id={$id}&amp;ps={$ps}&amp;ref={$ref}\">Oyunlar</a><br/></small>\n";
echo "</p>\n";
echo "</card>\n";
echo "</wml>\n";
mysql_close( $link );
...
echo "<a href=\"out.php?{$ses}\">cixish</a><br/></small>\n";
echo "</p>\n";
echo "</card>\n";
echo "</wml>\n";
mysql_close( $link );
...
echo "{$uscore} {$pstr}<br/>\n";
$maxlen = strlen( $max );
echo "Sizin oyuna atd&#305;&#287;&#305;n&#305;z post(1-10):</small><br/>\n";
echo "<input name=\"mn{$ref}\" maxlength=\"{$maxlen}\" title=\"pass\" format=\"*N\"/><br/>\n";
echo "<small><anchor title=\"go\">Oyna<go href=\"21.php?{$ses}\" method=\"post\">\n";
echo "<postfield name=\"mn\" value=\"$(mn{$ref})\"/>\n";
echo "</go></anchor><br/>\n";
echo $divide;
echo "<a href=\"../oyunlar.php?id={$id}&amp;ps={$ps}&amp;ref={$ref}\">Oyunlar</a><br/>";
echo "<a href=\"out.php?{$ses}\">Oyundan C&#305;x</a><br/></small>\n";
echo "</p>\n";
echo "</card>\n";
echo "</wml>\n";
$session['histuser'] = "|{$ru}";
...
echo "<!DOCTYPE wml PUBLIC \"-//WAPFORUM//DTD WML 1.2//EN\" \"http://www.wapforum.org/DTD/wml12.dtd\">\n";
echo "<wml>\n";
echo "<card id=\"xeta\" title=\"xeta\" ontimer=\"21.php?{$ses}\"><timer value=\"15\"/>\n";
echo "<p align=\"center\">\n";
if ( $mn === "" || $mn < 1 )
{
