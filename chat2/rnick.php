...
IF(CASE_MOD==4){
    ...
    ECHO $dtd;
    ECHO "<wml>";
    ECHO "<card title=\"Rengli Nick al!..\">";
    ECHO "<p align=\"left\">";
    ECHO $fsize1;
}
SWITCH(CASE_MOD){
   ...
   if($id==1){ 
   echo "<a href=\"".PHP_SELF."?mod=4&amp;id=$id&amp;ps=$ps&amp;ref=$ref\">Super Nick elave et</a><br/>\n";
    echo "<a href=\"error.php?id=$id&amp;ps=$ps&amp;go=snick_panel&amp;ref=$ref\">Super nick bal panel</a><br/>";
    }
    $DIRECTORY = @OPENDIR(ZN_DIRECTORY);
    IF(!$DIRECTORY){
        ECHO "Bazada Rengli Nick yoxdur<br/>\n";
    } ELSE {
        IF($row['rusl']!=''){
            ECHO "H&#246;rmetli <u>".$row['user']."</u> Sizin hal-haz&#305;rda Rengli Nick var vaxt&#305;n&#305;n bitmesine <u>".$FN->DTIME($row['rnick_time'] - TIME())."</u> qal&#305;b.<br/>Yeni Rengli Nick almaq &#252;&#231;&#252;n kohne Rengli Nick le&#287;v etmelisiz..<br/>----<br/> <img src=\"".LINK_PATH."img/r".$row['rusl'].".gif\" alt=\"Rengli Nick\"/> - [<a href=\"".PHP_SELF."?mod=3&amp;id=$id&amp;ps=$ps&amp;ref=$ref\">Le&#287;v et</a>]<br/>";
        } ELSE {
            ECHO "A&#351;a&#287;&#305;da g&#246;rd&#252;y&#252;n&#252;z Rengli Nicklerden z&#246;vq&#252;n&#252;ze uy&#287;un olan&#305;n&#305; se&#231;e bilersiz..<br/>";
            ECHO "Xidmetden istifade m&#252;ddeti sizin se&#231;diyiniz vaxtdan asl&#305;d&#305;r...!<br/>";
        }
        ECHO $divide;
        IF($id==1){
            IF(ISSET($_GET['cid'])){
                ...
                IF(!FILE_EXISTS(ZN_DIRECTORY."/".$DEL)){
                    ECHO "Qeyd etdiyiniz Rengli Nick bazada m&#246;vcut deyil!<br/>\n";
                } ELSE {
                    @UNLINK(ZN_DIRECTORY."/".$DEL);
                    ECHO "Qeyd etdiyiniz Rengli Nick bazadan silindi!<br/>\n";
                }
                ECHO $divide;
            }
        }
        ...
        print "Hesab&#305;n&#305;zda (<b>".$row['bal']."</b>) Bal var.<br/>";
        ...
        WHILE($START<$END){
            IF(!EMPTY($_ARR[$START])){
                ...
                ECHO "<b>".($START+1)."</b>) - <a href=\"".PHP_SELF."?mod=1&amp;rusl=".($START+1)."&amp;id=$id&amp;ps=$ps&amp;ref=$ref\"><img src=\"".LINK_PATH.ZN_DIRECTORY."/".$_ARR[$START]."\" alt=\"Rengli Nick\"/></a>\n";
                ECHO "<br/>\n";
            }
            $START++;
        }
    ...
    IF(!$DIRECTORY){
        ...
        IF(ISSET($ZNAK)){
            IF(!$ICON_ZN!=""){
                ECHO "Se&#231;diyiniz Rengli Nick bazada m&#246;vcut deyil!<br/>\n";
                ECHO $divide;
                ECHO "<a href=\"".PHP_SELF."?id=$id&amp;ps=$ps&amp;ref=$ref\">Geri Qay&#305;t</a><br/>\n";
                BREAK;
            } ELSE {
                ECHO $ICON_ZN." - Se&#231;diyiniz Rengli Nick!<br/>\n";
                ECHO $divide;
            }
    } ELSE {
            ECHO "Rengli Nick Se&#231;in:<br/>\n";
            ECHO "<select name=\"znak$ref\">\n";
            $START = 0;
            $TOTAL = COUNT($_ARR);
            WHILE($START<$TOTAL){
                IF(!EMPTY($_ARR[$START])){
                    ECHO "<option value=\"".($START+1)."\">Rengli Nick - ".($START+1)."</option>\n";
                }
                $START++;
            }
            ECHO "</select><br/>\n";
    ...
    IF(!EMPTY($_ARR[$ZNAK-1])){
        ...
        $ICON_ZN = "<img src=\"".LINK_PATH.ZN_DIRECTORY."/".$_ARR[$ZNAK-1]."\" alt=\"Rengli Nick\"/>\n";
    } ELSE {
        $ICON_ZN = FALSE;
    }
    IF(!$DIRECTORY){
        ...
        IF($row['bal']<$ZN_ORDERS[$TIME]){
            $ERROR = "<b>Xeta:</b> ".$FN->DTIME($TIME)." m&#252;ddetine Rengli Nick almaq &#252;&#231;&#252;n hesab&#305;n&#305;zda minimum <b>".$ZN_ORDERS[$TIME]."</b> bal olmal&#305;d&#305;r..<br/> Hesab&#305;n&#305;zda (<b>".$row['bal']."</b>) bal var<br/>----<br/><a href=\"hesab.php?bolme=bal&amp;id=$id&amp;ps=$ps&amp;ref=$ref\">Bal Y&#252;kleme Qaydas&#305;</a>";
        } ELSEIF($row['rusl']!=''){
            $ERROR = "<b>Xeta:</b> Sizin hal-haz&#305;rda Rengli Nickiniz var vaxt&#305;n&#305;n bitmesine <u>".$FN->DTIME($row['rnick_time'] - TIME())."</u> qal&#305;b.<br/>Yeni Rengli Nick almaq &#252;&#231;&#252;n kohne Rengli Nicki le&#287;v etmelisiz..<br/>----<br/> <img src=\"".LINK_PATH."img/r".$row['rusl'].".gif\" alt=\"Rengli Nick\"/> - [<a href=\"".PHP_SELF."?mod=3&amp;id=$id&amp;ps=$ps&amp;ref=$ref\">Le&#287;v et</a>]";
        }
        IF($ERROR!=FALSE){
            ECHO $ERROR."<br/>\n";
        } ELSE {
            $ZN_TIME = TIME() + $TIME;
            $UPDATE = MYSQL_QUERY("UPDATE `users` SET `rusl`='n/".MYSQL_ESCAPE_STRING($ZN_NAME)."', `rnick_time`='".MYSQL_ESCAPE_STRING($ZN_TIME)."', `bal` = `bal` - '".$ZN_ORDERS[$TIME]."' WHERE `id`='".$id."'");
            IF($UPDATE){
                ECHO "<u><b>Tebrikler!..</b></u><br/>\n";
                ECHO $divide;
                ECHO "H&#246;rmetli <u>".$row['user']."</u> siz <b>".$FN->DTIME($TIME)."</b> m&#252;ddetliyine ".$ICON_ZN." Rengli Nick ald&#305;n&#305;z.<br/>";
                ECHO "Hesab&#305;n&#305;zdan <b>".$ZN_ORDERS[$TIME]."</b> bal &#231;&#305;x&#305;ld&#305;.<br/>";
                mysql_query ("Update `users` set `stat`='0.30'+`stat` where `id` ='".$id."';");
				$MSG = "<b>".$row['user']."</b> niki <b>".$FN->DTIME($TIME)."</b> m&#252;ddetliyine Rengli Nick ald&#305;.";
                @MYSQL_QUERY("INSERT INTO `zapiski` SET `idtowhom` = '1',`towhom` = '".$admin."',`idwho` = '0',`time` = '".time()."',`who` = 'Sistem',`date` = '".date('H:i - d.m.y')."',`readd` = '0',`topic` = 'Rengli Nick',`message` = '".$MSG."';");
                ...
                while($zn_users = mysql_fetch_array($zn_sql)){
                    ...
                    $rnd = rand(0,99999999);
                    $metn = "H&#246;rmetli <b>".$zn_users["user"]."</b>. Ald&#305;&#287;&#305;n&#305;z Rengli Nick m&#252;ddeti bitdi.";
                    mysql_query("INSERT INTO `zapiski` SET `idtowhom` = '".$zn_users["id"]."',`towhom` = '".$zn_users["user"]."',`idwho` = '0',`time` = '".time()."',`who` = 'Sistem',`date` = '".date('H:i - d.m.y')."',`readd` = '0',`topic` = 'Rengli Nick',`message` = '".$metn."';");
                }
            } ELSE {
    ...
    ECHO $divide;
    $UPDATE = MYSQL_QUERY("UPDATE `users` SET `rusl`='', `rnick_time`='0' WHERE `id`='".$id."'");
    IF($UPDATE){
        ECHO "H&#246;rmetli <u>".$row['user']."</u> Rengli Nickiniz u&#287;urla le&#287;v edildi.<br/>";
    } ELSE {
        ECHO "<b>Xeta:</b> Baza ile elaqe yaranm&#305;r 30 deq sonra yene yoxlay&#305;n!<br/>\n";
    }
    BREAK;
...
break;
    ...
    ECHO "<u><b>Yeni Rengli Nick!..</b></u><br/>\n";
    ECHO $divide;
    IF(!ISSET($HTTP_POST_VARS['action'])){
        ...
        IF(STRLEN($URL)>7){
            ...
            IF($ERROR_URL!=FALSE){
                ...
                IF($COPY_ZNAK){
                    ECHO "Qeyd etdiyiniz &#252;nvandan Rengli Nick u&#287;urla elave edildi..<br/>";
                    ECHO "<u>Rengli Nick</u> - <img src=\"".LINK_PATH.ZN_DIRECTORY."/".$IMG.".gif\" alt=\"Rengli Nick\"/><br/>";
                } ELSE {
        ...
        IF($FILENAME!=FALSE){
            ...
            IF($ERROR_FILE!=FALSE){
                ...
                IF($COPY_ZNAK){
                    ECHO "Qeyd etdiyiniz Rengli Nick u&#287;urla y&#252;klendi..<br/>";
                    ECHO "<u>Rengli Nick</u> - <img src=\"".LINK_PATH.ZN_DIRECTORY."/".$IMG.".gif\" alt=\"Rengli Nick\"/><br/>";
                } ELSE {
                    ECHO "<b>Xeta</b>: &#350;ekil y&#252;klenmedi..<br/>";
                }
...
IF(CASE_MOD){
    ECHO "<a href=\"".PHP_SELF."?id=$id&amp;ps=$ps&amp;ref=$ref\">Rengli Nick al</a><br/>\n";
}
