...
echo "<card title=\"ERROR\" ontimer=\"../enter.php?ver=wml&amp;id=$id&amp;ps=$ps\"><timer value=\"15\"/><p align=\"left\">\n";
...
echo "<small><b>Bu Siqaretin Deyeri 150 bal</b></small><br/>\n";
echo "-<br/>\n";
if(!isset($_POST['action']))
{
echo "<small><anchor>[Bu Siqareti Al]<go href=\"kent.php?id=$id&amp;ps=$ps&amp;ver=wml\" method=\"post\">\n";
...
{
mysql_query("Update `users` set `bal`=bal-'150' where id ='".$id."';");
mysql_query("Update `users` set `siqaret`='1' where id ='".$id."';");
...
$kol = rand(0,99999999);
$time = time();
$topicad = "Siqaret aldilar!!!";
$messagead = "H&#246;rmetli Admin! <b>$us</b> leqebli istifade&#231;i <u>Kent</u> siqareti ald&#305;";
