...
echo "<card id=\"ok\" title=\"Azad edildi\">\n";
echo "<p align=\"center\">\n";
echo $fsize1;
...
echo "<wml>\n";
echo "<head><meta http-equiv=\"Cache-Control\" content=\"no-cache\" forua=\"true\"/></head>\n";
echo "<card id=\"ignolist\" title=\"&#304;qnor listi\">\n";
echo "<p>\n";
...
echo "<wml>\n";
echo "<head><meta http-equiv=\"Cache-Control\" content=\"no-cache\" forua=\"true\"/></head>\n";
echo "<card id=\"add\" title=\"&#304;qnor listine elave et\">\n";
echo "<p>\n";
...
echo $fsize1;
echo "<anchor title=\"send\">Elave Et<go href=\"ignor.php?mod=add&amp;id=$id&amp;ps=$ps&amp;ref=$ref\" method=\"post\">\n";
