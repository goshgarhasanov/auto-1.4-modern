...
echo "<wml>\n";
echo "<card id=\"top\" title=\"TOP-10\">\n";
echo "<p align=\"left\">\n";
echo $fsize1;
switch($mod) {

case 'hediyye':
echo "Aktiv istifade&#231;iler aras&#305;nda her ay&#305;n ax&#305;r&#305; ilk &#252;&#231;l&#252;ye &#231;&#305;xanlara hediyyeler a&#351;a&#287;dak&#305;lard&#305;r.<br/>*****<br/>";
...
case 'agill':
echo "<b>En A&#287;&#305;ll&#305; istifade&#231;iler</b>:\n";
echo "<br/>****<br/>";
...
$ind = mysql_fetch_array ($qus);
$u_user = $ind["user"];
echo ($i++).") <a href=\"galery.php?mod=m&amp;id=$id&amp;ps=$ps&amp;ref=$ref\"><img src=\"image.php?img=photos/$u_id/$photo&amp;size=40\" alt=\"FoTo\"/></a> <a href=\"inside.php?id=$id&amp;ps=$ps&amp;nk=$u_id&amp;ref=$ref\">".$u_user."</a> (<b>".$vote."</b> Ses)<br/>";
}
...
$fotoq=mysql_fetch_array(mysql_query("SELECT user FROM users where id ='".$fotoq['0']."'"));
echo "- Chat&#305;n yara&#351;&#305;ql&#305; o&#287;lan&#305;: <b>$fotoq[0]</b> - <a href=\"galery.php?mod=m&amp;id=$id&amp;ps=$ps&amp;ref=$ref\">ard&#305;</a><br/>\n";
