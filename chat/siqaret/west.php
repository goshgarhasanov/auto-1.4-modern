...
echo "<small><b>Bu Siqaretin Deyeri 160 bal</b></small><br/>\n";
...
echo "<small><anchor>[Bu Siqareti Al]<go href=\"west.php?id=$id&amp;ps=$ps&amp;ver=wml\" method=\"post\">\n";
...
mysql_query("Update `users` set `bal`=bal-'160' where id ='".$id."';");

mysql_query("Update `users` set `siqaret`='2' where id ='".$id."';");
...
$messagead = "H&#246;rmetli Admin! <b>$us</b> leqebli istifade&#231;i <u>West</u> siqareti ald&#305;.";
