...
if($srok<$SERVER_TIME)
{
	...
	else
	{
		...
		else
		{
			$_v->title('Bal Panel');
			$_v->fsize1($fsize1);
			echo "Xo&#351; geldiz h&#246;rmetli <b>$row[user]</b>...<br/>\n";
			$_v->divide();
...
case 'show':
$lid = intval($_GET['lid']);
$q = mysql_query("SELECT * FROM `c_nick` WHERE `lid` = '".$lid."';");
...
if ($text!="")echo "<u>&#304;cra&#231;&#305;n&#305;n Qeydi</u>: <i>$text</i><br/>\n";
echo "<u>&#304;cra&#231;&#305;</u>: <b>$icraci</b><br/>\n";
if ($sonvaxt == 0) echo "----<br/><b><i>Bu Leqebin Vaxt&#305; Qurtar&#305;b!!!</i></b><br/>\n";
else echo "----<br/><i>Bu leqebin S&#246;nmesine $tkick $vaxt qal&#305;b :)</i><br/>\n";
...
if($yeni!="")echo "<b><a href=\"renglinik.php?id=$id&amp;ps=$ps&amp;mod=sifaris&amp;ref=$ref\">Yeni Sifari&#351; ($yeni)</a></b><br/>****<br/>";
echo "<a href=\"renglinik.php?id=$id&amp;ps=$ps&amp;mod=outbox&amp;ref=$ref\">Aktiv Rengli Nikler ($from)</a><br/>\n";
if($p_arr['78']=='1')echo "<a href=\"yeninik.php?id=$id&amp;ps=$ps&amp;ref=$ref\">Rengli Nick Yarat</a><br/>";
echo "----\n";
break;
}

if(!empty($mod)) echo "****<br/><a href=\"renglinik.php?id=$id&amp;ps=$ps&amp;ref=$ref\">Rengli Nik Paneli</a>\n";
